...
namespace nethttp {
    inline std::string parse_body(const std::string &body, const http_headers &headers) {
    ...
    inline std::istream &read_body(std::string &body, const http_headers &headers, std::istream &is) {
